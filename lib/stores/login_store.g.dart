...
mixin _$LoginStore on _LoginStore, Store {
  Computed<String> _$isPasswordValidComputed;

  @override
  String get isPasswordValid => (_$isPasswordValidComputed ??= Computed<String>(
          () => super.isPasswordValid,
          name: '_LoginStore.isPasswordValid'))
      .value;
  Computed<String> _$isEmailValidComputed;

  @override
  String get isEmailValid =>
      (_$isEmailValidComputed ??= Computed<String>(() => super.isEmailValid,
